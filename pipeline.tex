...
\put(62,33){$v_R$}
\end{overpic}}}};
\node[inner sep=0pt] (1) at (-4,0.8){\includegraphics[width=.1\textwidth]{figures/p1.png}};
\node at (-4,-0.35) {\vdots};
\node[inner sep=0pt] (2) at (-4,-1.5) {\includegraphics[width=.1\textwidth]{figures/p2.png}};
...
\node[inner sep=0pt] (smpl) at (-4,-4){\includegraphics[width=.1\textwidth]{figures/smpl.png}};
\node[decision] (retarget) at (-1,-4) {Physics Body Model Generator};
\draw[vecArrow] (smpl) to (retarget);

\node[inner sep=0pt] (humanoid) at (2,-4){\includegraphics[width=.1\textwidth]{figures/humanoid.png}};
...
\node[inner sep=0pt] (final) at (9,-4){\includegraphics[width=.125\textwidth]{figures/final.png}};
